...
import { a as useRuntimeConfig$1, d as sendRedirect, c as createError$1, s as setResponseStatus$1, f as defu } from './node-server.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-ee0ee615.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-b0e48c20.mjs').then((r) => r.default || r));
